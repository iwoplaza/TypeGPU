...
The [Text Radiance Cascades](/TypeGPU/examples#example=rendering--text-radiance-cascades) example does the same with text rendered by `@pmndrs/glyph`, turning letters into light sources and shadow casters.
