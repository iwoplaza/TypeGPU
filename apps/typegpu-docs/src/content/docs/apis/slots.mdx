...
The [Slots and Accessors](/TypeGPU/examples#example=simple--slots-and-accessors) example uses this to build three render pipelines from one shader, each with its own pattern function and column index filled in.
